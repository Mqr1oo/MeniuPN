// =====================================================================
// Á LIBRETTO — Service Worker pentru MENIUL DIGITAL (index.html)
// =====================================================================
// Strategie:
//  - HTML (navigare) și menu.json => network-first (mereu proaspăt).
//  - Imagini/manifest/icons => cache-first, dar NU cache-uim niciodată
//    un răspuns eșuat (404, opac-eroare etc.).
//  - Supabase / fonturi / CDN => nu se ating NICIODATĂ (trec direct).
//  - skipWaiting() + clients.claim() => nu e nevoie de refresh dublu.
//
// IMPORTANT: acest fișier trebuie servit de server cu
//   Cache-Control: no-cache
// (sau max-age=0), altfel browserul poate rula o versiune veche a
// acestui script chiar dacă tu îl actualizezi pe server. Vezi nota
// de mai jos, în afara codului.
// =====================================================================
